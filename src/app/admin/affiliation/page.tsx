...
export default function AdminAffiliationPage() {
  ...
  const [stats, setStats] = useState({ totalAffiliés: 0, totalFilleuls: 0, totalCommissions: 0, totalRetraits: 0, enAttente: 0 })
  ...
  async function load() {
    ...
    setStats({
      ...
      totalFilleuls: allAffiliés.reduce((s: number, a: any) => s + (a.nb_filleuls || 0), 0),
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 10, marginBottom: 24 }}>
        {[
          ...
          { lbl: '🤝 Filleuls', val: stats.totalFilleuls, color: '#1D9E75' },
